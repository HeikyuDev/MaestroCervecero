...
/**
 * DTO de respuesta para representar una version del proveedor.
 */
@NoArgsConstructor
@AllArgsConstructor
@Getter
@Builder
public class VersionProveedorResponseDTO {
    ...
    /**
     * Indica si esta versión es la última versión del proveedor.
     */
