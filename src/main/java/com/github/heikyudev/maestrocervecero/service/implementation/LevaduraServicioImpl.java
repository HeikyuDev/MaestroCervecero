...
import com.github.heikyudev.maestrocervecero.service.interfaces.ILevaduraServicio;
import com.github.heikyudev.maestrocervecero.service.response_dto.LevaduraResponseDTO;
import com.github.heikyudev.maestrocervecero.util.mapper.MapperLevadura;
...
public class LevaduraServicioImpl implements ILevaduraServicio {
    ...
    public Page<LevaduraResponseDTO> findAll(Pageable pageable) {
    ...
    @Override
    @Transactional(readOnly = true)
    public LevaduraResponseDTO obtenerPorId(Long id) {
