...
import com.github.heikyudev.maestrocervecero.service.interfaces.IMaltaServicio;
import com.github.heikyudev.maestrocervecero.service.response_dto.MaltaResponseDTO;
import com.github.heikyudev.maestrocervecero.util.mapper.MapperMalta;
...
public class MaltaServicioImpl implements IMaltaServicio {
    ...
    public Page<MaltaResponseDTO> findAll(Pageable pageable) {
    ...
    @Override
    @Transactional(readOnly = true)
    public MaltaResponseDTO obtenerPorId(Long id) {
