 ...
 * orden de producción (velocidad de molienda, envasado, tiempo de CIP y
 ...
 * arrancar la aplicación (ver {@code ConfiguracionOrdenProduccionDataLoader})
 ...
 */
@Entity
@Table(name = "configuracion_orden_produccion")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class ConfiguracionOrdenProduccionEntity extends AuditableEntity<String> {
     ...
     * actual (ej. {@code repository.findById(ConfiguracionOrdenProduccionEntity.SINGLETON_ID)}).
     */
