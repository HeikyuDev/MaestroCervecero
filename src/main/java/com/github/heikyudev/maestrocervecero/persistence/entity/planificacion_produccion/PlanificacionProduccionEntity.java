...
/**
 * Representa una planificación de producción: la puesta en marcha de una {@link VersionRecetaEntity}
...
public class PlanificacionProduccionEntity extends AuditableEntity<String> {
