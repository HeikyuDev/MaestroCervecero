...
/**
 * Insumo de tipo Levadura. Hereda de {@link InsumoEntity} y mapea a la tabla propia
 * {@code levadura}, unida a la tabla raíz {@code insumo} por FK ({@code insumo_id}),
...
@NoArgsConstructor
@AllArgsConstructor
public class LevaduraEntity extends InsumoEntity {

    @Enumerated(EnumType.STRING)
    @Column(name = "tipo", nullable = false)
    private TipoLevadura tipo;

    @Column(name = "cantidad_celulas_por_gramo", nullable = false)
