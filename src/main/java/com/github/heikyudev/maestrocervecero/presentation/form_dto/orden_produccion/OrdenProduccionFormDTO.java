...
/**
 * DTO de formulario para el Registro de una Orden de Producción.
 * <p>
...
@NoArgsConstructor
@AllArgsConstructor
public class OrdenProduccionFormDTO {
    ...
    /**
     * Identificador de la receta a utilizar en esta orden de producción.
     * <p>
