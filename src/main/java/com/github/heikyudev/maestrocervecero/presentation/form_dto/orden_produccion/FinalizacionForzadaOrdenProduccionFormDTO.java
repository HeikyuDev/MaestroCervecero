...
/**
 * DTO de formulario para la finalización forzada de una Orden de Producción.
 * <p>
...
@NoArgsConstructor
@AllArgsConstructor
public class FinalizacionForzadaOrdenProduccionFormDTO {

    /**
     * Motivo por el cual se finaliza de forma forzada la orden de producción.
     */
